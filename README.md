...
### 🔬 Research Profile
My work sits at the intersection of natural language processing, generative AI, and human-centered systems. I build intelligent solutions where model decisions are interpretable, reliable, and grounded in real-world applications like healthcare and education.

| Natural Language Systems | Healthcare & Clinical AI | Multimodal & Applied AI |
| :--- | :--- | :--- |
| Large Language Models, Prompt Engineering, Retrieval-Augmented Generation (RAG), and Explainable AI. | Clinical decision support, multi-agent evaluation, movement sciences, and rehabilitation tech. | Computer vision integrations, conversational AI tutors, offline learning, and human-in-the-loop workflows. |

<br />

### 🧪 Selected Research & AI Systems

| System | Research / Engineering focus | What it demonstrates |
| :--- | :--- | :--- |
| [**CrisisGPT**](https://github.com/MotsimAslam/CrisisGpt) | NLP · LLMs · Multilingual AI | Evaluates disaster reports using LLaMA 3.1 for multilingual incident understanding, automated classification, and emergency response support. |
| [**MedContextAI**](https://github.com/MotsimAslam/MedContextAI) | Generative AI · Multi-Agent | Coordinates multiple AI agents to process medical documents for extraction, clinical evaluation, and confidence-aware structured reporting. |
| [**AfriLearn AI Tutor**](https://github.com/MotsimAslam/Afri-AI-Tutor) | AI Education · Conversational | Delivers accessible, voice-based AI tutoring in English, French, and Swahili with specialized offline learning capabilities. |
| [**AI Cardio Assistant**](https://github.com/MotsimAslam/AI-Powered-Cardiovascular-Health-Assistant-Fall-in-Love-with-DeepSeek-Hackathon) | Predictive Modeling · Healthcare | Combines cardiovascular risk prediction with multi-agent personalized health guidance and an intelligent patient-facing interface. |

<br />

### ⚙️ System Design Focus
The recurring design pattern in my work is **Human-Centered AI**: combining structured extraction, verifiable outputs, and multi-agent coordination to address ambiguity while protecting the final clinical or educational output.

```text
       Multimodal Input (Text/Medical Docs/Images)
                             ↓
              Information & Feature Extraction
                             ↓
    ┌────────────────────────┼────────────────────────┐
    ↓                        ↓                        ↓
 NLP / LLMs             Generative AI            Vision Systems
    │                        │                        │
    └────────────────────────┼────────────────────────┘
                             ↓
             Confidence Assessment & Verification
                             ↓
         Interpretable Decision / Structured Report
```
## 🛠️ Technical Toolkit
